...
void SideBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->expandFinished(); break;
        case 1: _t->shrinkFinished(); break;
        case 2: _t->finished(); break;
        case 3: _t->expandStart(); break;
        case 4: _t->shrinkStart(); break;
        case 5: _t->widthChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 6: _t->shrinkWidthChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 7: _t->hasShown(); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (_t _q_method = &SideBar::widthChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (SideBar::*)(int );
            if (_t _q_method = &SideBar::shrinkWidthChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (SideBar::*)();
            if (_t _q_method = &SideBar::hasShown; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 7;
                return;
            }
        }
...
// SIGNAL 5
void SideBar::widthChanged(int _t1)
{
...
// SIGNAL 6
void SideBar::shrinkWidthChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
